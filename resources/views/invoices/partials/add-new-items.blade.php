        ...
        <table class="table" id="itemsTable">
            ...
            <tbody>
                <tr>
                    ...
                    @if (session('category') === 'daily')
                        <td>
                            <input type="number" name="products[0][days]" class="form-control days-input"
                                value="1" min="1" data-manual="false">
                        </td>
                        <td>
                            <input type="datetime-local" name="products[0][rental_start_date]"
                                class="form-control rental-start-date">
                        </td>
                        <td>
                            <input type="datetime-local" name="products[0][rental_end_date]"
                                class="form-control rental-end-date">
                        </td>
                    @else
                        <td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addRow').addEventListener('click', function() {
                ...
                if (isSeasonal) {
                    newRow +=
                        `<td><input type="text" value="Seasonal Rental" class="form-control" readonly></td>`;
                } else {
                    newRow +=
                        `
            ...
            document.getElementById('itemsTable').addEventListener('input', function(e) {
                ...
                const isStartEndField = e.target.classList.contains('rental-start-date') || e.target
                    .classList.contains('rental-end-date');
